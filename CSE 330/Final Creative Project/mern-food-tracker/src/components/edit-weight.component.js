...
export default class CreateWeight extends Component {
    ...
    componentDidMount() { //automatically called before page is loaded
        axios.get('http://localhost:5000/weights/' + this.props.match.params.id) ///get id from the url 
            .then(response => {
                this.setState({
    ...
    onSubmit(e) {
        ...
        axios.post('http://localhost:5000/weights/update/' + this.props.match.params.id, weight)
            .then(res => console.log(res.data));
        alert("Weights succesfully updated!");
    }
